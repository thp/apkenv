...
const char *
my_eglQueryString(EGLDisplay dpy, EGLint name) SOFTFP;
...
EGLBoolean
my_eglBindAPI(EGLenum api) SOFTFP;
EGLenum
my_eglQueryAPI(void) SOFTFP;

EGLBoolean
my_eglWaitClient(void) SOFTFP;

EGLBoolean
my_eglReleaseThread(void) SOFTFP;
...
my_eglSurfaceAttrib(EGLDisplay dpy, EGLSurface surface,
			    EGLint attribute, EGLint value) SOFTFP;
EGLBoolean
my_eglBindTexImage(EGLDisplay dpy, EGLSurface surface, EGLint buffer) SOFTFP;
EGLBoolean
my_eglReleaseTexImage(EGLDisplay dpy, EGLSurface surface, EGLint buffer) SOFTFP;


EGLBoolean
my_eglSwapInterval(EGLDisplay dpy, EGLint interval) SOFTFP;
...
EGLContext
my_eglGetCurrentContext(void) SOFTFP;
EGLSurface
my_eglGetCurrentSurface(EGLint readdraw) SOFTFP;
EGLDisplay
my_eglGetCurrentDisplay(void) SOFTFP;
EGLBoolean
my_eglQueryContext(EGLDisplay dpy, EGLContext ctx,
			   EGLint attribute, EGLint *value) SOFTFP;

EGLBoolean
my_eglWaitGL(void) SOFTFP;
EGLBoolean
my_eglWaitNative(EGLint engine) SOFTFP;
EGLBoolean
